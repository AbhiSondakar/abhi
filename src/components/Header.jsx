...
const Header = () => {
  ...
  const navLinks = [
    ...
    { path: '/work', label: 'Projects', id: 'nav-work' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6 relative">
            ...
            <Link
              to="/contact"
              className={`text-gray-600 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white transition duration-300 font-medium ${isActive('/contact') ? 'text-active active-underline' : ''
                }`}
            >
              Contact
            </Link>
            ...
            <a
              ...
              className="px-4 py-2 bg-primary-accent text-gray-900 font-bold rounded-lg hover:bg-teal-300 transition duration-300 text-sm"
            >
              Resume
            </a>
